...
namespace ColyseusTest
{
    ...
    public class ColyseusClientManager : MonoBehaviour
    {
        ...
        private static extern void InstallColyseus();
        //[DllImport("__Internal")]
        //private static extern void InstallCryptor();
        ...
        /* public async void JoinRoom(string match_id, string access_token, UnityAction actionAfterJoin)
       {
           InitializeClient();
        ...
        JSON stringedScoreJson = new JSON();
        public void SendScoreToServer(int score, string pubKey) //incremental, so every +1, need to be send, multiplied 5x means send 5x
        {
...
public partial class State : Schema
{
    ...
    [Colyseus.Schema.Type(0, "array", typeof(ArraySchema<Player>))]
